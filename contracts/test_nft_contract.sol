...
contract TestM3 is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    string private _contractURI;
    uint256 public nextTokenId = 1;
    uint256 public MAX_MINT_ETHEREUM = 5000;
    uint gasForDestinationLzReceive = 350000;

    uint128 public PUBLIC_SUPPLY = 4900; //TODO: determine reserve
    uint128 public MAX_SUPPLY = 5000;
    uint128 public PUBLIC_MINT_LIMIT = 11;
    uint128 public PRESALE_PRICE = 0.07 ether;
    uint128 public PUBLIC_PRICE = 0.07 ether;
